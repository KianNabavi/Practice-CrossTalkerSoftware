...
function drawRectangles() {
    ...
    .attr("x", offsetX + (imgWidth/2) - centerSize)
    .attr("y", offsetY)
    .attr("width", imgWidth)
...
function drawAxes() {
    ...
    if (timeCol != null) {
        drawDiagScale();
        drawScaledTicks(timeCol, yLeftScale, yRightScale, diagScale);
    }
    ...
    function drawArrows(fluxData, yLeftScale, yRightScale, diagScale) {
    ...
    drawArrows(fluxData, yLeftScale, yRightScale, diagScale);
}
...
*/
function drawScaledTicks(timeCol, yLeftScale, yRightScale, diagScale) {
...
// console.log("After:", metabolites.map(r => r[4]));
        ...
        ['compoundSelect', 'leftSpeciesSelect', 'rightSpeciesSelect', 'timeDropdown']
...
function populateSpeciesDropdowns() {
    ...
    ['leftSpeciesSelect', 'rightSpeciesSelect'].forEach(id => {
